 ...
 * 描述: 微信头条推荐内容
 */
public class MilitaryFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
                ...
                try {
                    ...
                    if (dataBean != null && dataBean.getData() != null) {
                        if (dataBean.getData().getArticle() != null && dataBean.getData().getArticle().size() > 0) {
                            ...
                            LogUtil.e("MilitaryFragment"+dataBean.getData().getArticle().get(0).getAuthor());
